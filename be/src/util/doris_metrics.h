...
public:
    ...
    METRIC_DEFINE_INT_COUNTER(push_requests_success, MetricUnit::REQUESTS);
    METRIC_DEFINE_INT_COUNTER(push_requests_failed, MetricUnit::REQUESTS);
    ...
    METRIC_DEFINE_INT_COUNTER(drop_tablet_requests_failed, MetricUnit::REQUESTS);
    ...
    METRIC_DEFINE_INT_COUNTER(storage_migrate_requests_failed, MetricUnit::REQUESTS);
    ...
    METRIC_DEFINE_INT_COUNTER(read_meta_requests_total, MetricUnit::REQUESTS);
    METRIC_DEFINE_INT_COUNTER(write_meta_requests_total, MetricUnit::REQUESTS);
    METRIC_DEFINE_INT_COUNTER(read_meta_requests_duration_us, MetricUnit::MICROSECONDS);
    METRIC_DEFINE_INT_COUNTER(write_meta_requests_duration_us, MetricUnit::MICROSECONDS);
    ...
    METRIC_DEFINE_INT_COUNTER(segment_read_rows_read_by_zone_map, MetricUnit::ROWS);

    METRIC_DEFINE_INT_COUNTER(txn_request_begin, MetricUnit::OPERATIONS);
    METRIC_DEFINE_INT_COUNTER(txn_request_commit, MetricUnit::OPERATIONS);
    METRIC_DEFINE_INT_COUNTER(txn_request_rollback, MetricUnit::OPERATIONS);
    METRIC_DEFINE_INT_COUNTER(txn_request_exec, MetricUnit::OPERATIONS);

    METRIC_DEFINE_INT_COUNTER(stream_load_receive_bytes, MetricUnit::BYTES);
    METRIC_DEFINE_INT_COUNTER(stream_load_load_rows, MetricUnit::ROWS);
