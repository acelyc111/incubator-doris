...
class DeltaWriter {
public:
    static void open(const WriteRequest& req, const std::shared_ptr<MemTracker>& parent,
                     DeltaWriter** writer);
...
private:
    DeltaWriter(const WriteRequest& req, const std::shared_ptr<MemTracker>& parent,
