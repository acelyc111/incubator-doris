...
Status SegmentIterator::_init() {
    DorisMetrics::instance()->segment_read_times.increment(1);
...
Status SegmentIterator::_get_row_ranges_by_keys() {
    DorisMetrics::instance()->segment_read_rows.increment(num_rows());
    ...
    DorisMetrics::instance()->segment_read_rows_by_short_key.increment(_row_bitmap.cardinality());
...
Status SegmentIterator::_get_row_ranges_from_conditions(RowRanges* condition_row_ranges) {
    ...
    DorisMetrics::instance()->segment_read_rows_read_by_zone_map.increment(zone_map_row_ranges.count());
