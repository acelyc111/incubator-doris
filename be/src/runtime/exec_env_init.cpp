...
Status ExecEnv::_init(const std::vector<StorePath>& store_paths) {
    ...
    _backend_client_cache->init_metrics(DorisMetrics::instance()->metric_registry(), "backend");
    _frontend_client_cache->init_metrics(DorisMetrics::instance()->metric_registry(), "frontend");
    _broker_client_cache->init_metrics(DorisMetrics::instance()->metric_registry(), "broker");
    _extdatasource_client_cache->init_metrics(DorisMetrics::instance()->metric_registry(), "extdatasource");
    _result_mgr->init();
...
Status ExecEnv::_init_mem_tracker() {
    ...
    RETURN_IF_ERROR(_tmp_file_mgr->init(DorisMetrics::instance()->metric_registry()));
